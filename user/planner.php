        ...
        <div class="row align-items-end">
            <div class="col-lg-12">
                <div class="breadcrumb-content">
                    ...
                    <h2 class="page-title">Planner Registeration</h2>
            ...
            <div class="col-lg-8 offset-lg-2">
                <form id="plannerform">
                    <div class="contact-form-wrapper">
                        ...
                        <div class="primary-input-group mt-3">
                            <label class="lab">Skills <span class="text-danger">*</span></label>
                        ...
                        <div class="primary-input-group mt-3">
                            <label class="lab">Partners <span class="text-danger">*</span></label>
                            <small>E.g. lorem,ipsum,opag</small>
                            <input type="text" name="u_partners" id="u_partners" placeholder="Add Partners">
