...
<div class="content-wrapper">
    <!-- Modal -->
    <div class="modal center-modal fade" id="mymodel" tabindex="-1" aria-labelledby="volunteermodel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="volunteermodel">Planner Update</h5>
            ...
            <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">View Volunteer</li>
                ...
                <div class="ms-auto">
                    <a href="./volunteer-insert.php"
                        class="waves-effect waves-light text-white btn btn-rounded btn-dark mb-5">Add Volunteer</a>
                </div>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-lg invoice-archive">
                                    ...
                                    <tbody>
                                        ...
                                        $sql="SELECT * FROM `a_users` WHERE `u_role`='Volunteer' AND `u_status`='Confirmed'";
                                        $run=mysqli_query($conn,$sql);
                                        while($rec=mysqli_fetch_assoc($run)){
								?>
                                        <tr>
                                        <td class="td"><a class="btn btn-success" href="./volunteer-update.php?uid=<?php echo $rec['u_id'] ?>">Update</a></td>
                                            ...
                                            <td><?php echo $rec['u_occasions']?></td>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res == 1) {
                            ...
                            Toast.fire({
                                icon: 'success',
                                title: 'VOLUNTEER HAS BEEN DELETED'
                            })
                            $(msg).closest("tr").fadeOut();
                        } else {
                    alert("VOLUNTEER HAS NOT BEEN DELETED");
                }
                         } })
