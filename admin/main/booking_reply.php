            ...
            <div class="col-lg-6 col-sm-12 offset-lg-3 ">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Booking Reply</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form id="myreply">
                                    <?php
                                           $uid=$_GET['uid'];
                                           $gsql="SELECT * FROM `bookings` WHERE `b_id`='$uid'";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="b_id" class="form-control" value="<?php echo $gfet['b_id'] ?>" required>
                                        <div class="controls">
                                            <input type="text" name="contact_name"  class="form-control" value="<?php echo $gfet['b_client_name'] ?>" readonly
                                                placeholder="Enter Category Name" required>
                                                <div id="catvalid" style="height:15px; color:red; font-weight:bold;"></div>
                                        </div>
                                        <div class="controls">
                                            <input type="text" name="cont_email"  class="form-control" value="<?php echo $gfet['b_client_email'] ?>"readonly
                                                placeholder="Enter Category Name" required>
                                                <div id="catvalid" style="height:15px; color:red; font-weight:bold;"></div>
                                        </div>
                                        <div class="controls">
