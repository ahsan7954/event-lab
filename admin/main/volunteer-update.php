            ...
            <div class="col-lg-6 col-sm-12 offset-lg-3 ">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Update Volunteer</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="u_id" class="form-control" value="<?php echo $gfet['u_id'] ?>" required>
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="u_fname" id="u_fname" class="form-control" value="<?php echo $gfet['u_fname'] ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="u_occasions" 
                                        value="<?php echo $gfet['u_occasions'] ?>"
                                        id="u_occasion"
                                           data-role="tagsinput"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                ...
                                                name="u_pswd" id="u_pswd" class="form-control"
        ...
        $.ajax({
            ...
            success: function(show) {
                ...
                if (show == 5) {
                    ...
                    Toast.fire({
                        icon: 'success',
                        title: 'VOLUNTEER HAS BEEN UPDATED.'
                    })
                    $('#form').trigger('reset');
                    window.location.href="volunteer-pending.php";
                    ...
                    Toast.fire({
                        icon: 'error',
                        title: 'VOLUNTEER HAS BEEN NOT UPDATED.'
                    })
                }
            }
        });
